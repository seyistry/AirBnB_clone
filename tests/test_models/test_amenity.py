#!/usr/bin/python3
"""Test User Class - Improving expected outputs and documentation
"""
...
class TestBaseModel(unittest.TestCase):
    ...
    def test_instances(self, mock_storage):
        ...
        self.assertEqual(instance.name, "Hello world")
    ...
    def test_dictionary(self):
        """testing to_dict correct functionality"""
        """Testing that object is correctly created"""
        instance3 = Amenity()
        self.assertIs(type(instance3), Amenity)
        instance3.name = "Hello world"
        ...
        expected_attrs = ["id",
                          ...
                          "name",
                          "__class__"]
        self.assertCountEqual(new_inst.keys(), expected_attrs)
        self.assertEqual(new_inst['__class__'], 'Amenity')
        self.assertEqual(new_inst['name'], 'Hello world')
